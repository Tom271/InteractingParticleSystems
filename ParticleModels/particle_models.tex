...
\end{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{GarnierFigure7}
    \end{minipage} \\
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{Figure5scaled}
...
\end{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{Figure6scaled}
    \end{minipage} \\
...
\end{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{Figure7scaled}
    \end{minipage} \\
...
\begin{figure}\label{fig:skewhist}
    \centering
    \includegraphics[width=1.1\linewidth]{Fig3skewedxvhist}
...
\begin{figure}\label{fig:skewhist6}
    \centering
    \includegraphics[width=1.1\linewidth]{Fig6xvhist}
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{smallwellxvhist}
...
Garnier parameters but with smooth $G$. Aim: convert Garnier's results to our model.  (IN PROGRESS). Having $G$ gives three equilibria at $\xi = - 1, 0 ,+1$. The shape is similar to the $G$ function from Garnier with a low well depth.
    ...
    \begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{smoothFigure2}
    \caption{Garnier Figure 2 with smooth $G$.}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{smoothFigure3}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{smoothFigure4}
    \end{minipage} \\
    
    \begin{minipage}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{smoothFigure4b}
    \end{minipage} %
    \begin{minipage}[b]{0.49\textwidth}
        \centering                    \includegraphics[width=\textwidth]{smoothFigure4d}
    \end{minipage}
...
\begin{figure}
    \centering
    \includegraphics[width=1.1\linewidth]{smoothFigure5}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{smoothFigure6}
    \end{minipage} \\
    
    \begin{minipage}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{smoothFigure6b}
    \end{minipage} %
    \begin{minipage}[b]{0.49\textwidth}
        \centering                    
        \includegraphics[width=\textwidth]{smoothFigure6d}
    \end{minipage}
...
\begin{figure}
    ...
    \begin{minipage}[b]{\textwidth}
        ...
        \includegraphics[width=\textwidth]{smoothFigure7}
    \end{minipage} \\
    
    \begin{minipage}[b]{0.49\textwidth}
        \centering
        \includegraphics[width=\textwidth]{smoothFigure7b}
    \end{minipage} %
    \begin{minipage}[b]{0.49\textwidth}
        \centering                    
        \includegraphics[width=\textwidth]{smoothFigure7d}
    \end{minipage}
