...
for initial_dist_x in [
    ...
    long_time_axes[i] = plot_averaged_avg_vel(long_time_axes[i], search_parameters, logx=logged, exp_yaml=yaml_path, include_traj=True, start_time_step=200,end_time_step=1000)
    short_time_ax = plot_averaged_avg_vel(short_time_ax,search_parameters, logx=False, exp_yaml=yaml_path, include_traj=True, end_time_step=30)
    i += 1
